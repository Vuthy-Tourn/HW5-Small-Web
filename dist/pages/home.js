...
function renderHome() {
    ...
    <section class="relative overflow-hidden bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 py-20 px-4 sm:px-6 lg:px-8 min-h-screen">
      ...
      <div class="max-w-7xl mx-auto relative z-10 flex flex-col lg:flex-row items-center justify-between gap-12 py-12 lg:py-24">
        ...
        .fill(0)
        .map((_) => `
                <img src="https://randomuser.me/api/portraits/${Math.random() > 0.5 ? "men" : "women"}/${Math.floor(Math.random() * 50)}.jpg" 
                     alt="Team member" 
    ...
    <section class="py-16 bg-white dark:bg-gray-900">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
          ${createCategoryCard("Fashion", "https://images.unsplash.com/photo-1445205170230-053b83016050?ixlib=rb-4.0.3&auto=format&fit=crop&w=300&q=80")}
          ${createCategoryCard("Home & Living", "https://images.unsplash.com/photo-1586023492125-27b2c045efd7?ixlib=rb-4.0.3&auto=format&fit=crop&w=300&q=80")}
          ${createCategoryCard("Accessories", "https://images.unsplash.com/photo-1515562141207-7a88fb7ce338?ixlib=rb-4.0.3&auto=format&fit=crop&w=300&q=80")}
          ${createCategoryCard("Lifestyle", "https://images.unsplash.com/photo-1522338242992-e1a54906a8da?ixlib=rb-4.0.3&auto=format&fit=crop&w=300&q=80")}
        </div>
      </div>
    </section>
    ...
    <section class="py-20 px-4 sm:px-6 lg:px-8">
      <div class="max-w-7xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ${createTestimonialCard("Amazing quality and fast shipping! The dress I ordered exceeded my expectations.", "Sarah M.", "Fashion Lover", "https://randomuser.me/api/portraits/women/32.jpg")}
          ${createTestimonialCard("Love the home decor collection. Everything arrived perfectly packaged and looks beautiful in my apartment.", "Mike R.", "Interior Enthusiast", "https://randomuser.me/api/portraits/men/45.jpg")}
          ${createTestimonialCard("Excellent customer service and the return process was so easy. Will definitely shop here again!", "Emily K.", "Regular Customer", "https://randomuser.me/api/portraits/women/28.jpg")}
        </div>
      </div>
    </section>
...
function createCategoryCard(title, imageUrl) {
    return `
...
function createTestimonialCard(review, name, title, avatar) {
    return `
    <div class="bg-[#1649A1]/30 dark:bg-gray-700/30 p-8 rounded-2xl hover:shadow-lg hover:shadow-[#1649A1]/10 transition-all duration-500 border border-gray-800/50 hover:border-[#1649A1]/30">
      ...
      <div class="flex gap-1 text-amber-400">
        ${Array(5)
        .fill('<svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" /></svg>')
        .join("")}
      </div>
    </div>
  `;
