    ...
    <section class="py-20 px-4 sm:px-6 lg:px-8">
      <div class="max-w-7xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8" data-aos="fade-up">
          ...
          ${createValueCard(
            "Innovation",
            "We continuously evolve and embrace new technologies to enhance the shopping experience.",
            "🚀",
            "#1649A1"
          )}
          ${createValueCard(
            "Transparency",
            "Honest communication and clear processes build trust with our customers and partners.",
            "🔍",
            "#F35F25"
          )}
          ${createValueCard(
          ...
          ${createValueCard(
            "Community",
            "Building meaningful relationships and supporting the communities we serve is fundamental to who we are.",
            "🤝",
            "#F35F25"
          )}
        </div>
      ...
      <div class="max-w-7xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8" data-aos="fade-up">
          ...
          ${createTeamCard(
            ...
            "Ensures smooth operations and fast delivery"
          )}
        </div>
      </div>
    </section>
        ...
        <div class="relative">
          ...
          <div class="space-y-12">
            ${createTimelineItem(
              "2020",
              "The Beginning",
              "You&Me was founded with a simple vision: to create meaningful shopping experiences that bring people together.",
              "left"
            )}
            ${createTimelineItem(
              "2021",
              "First 1000 Customers",
              "Reached our first major milestone with 1000 happy customers and expanded our product catalog to 100+ items.",
              "right"
            )}
            ${createTimelineItem(
              "2022",
              "Going Global",
              "Launched international shipping and opened our first overseas warehouse to serve customers worldwide.",
              "left"
            )}
            ${createTimelineItem(
              "2023",
              "Mobile Revolution",
              "Launched our mobile app and introduced AR try-on features, making shopping more interactive and personal.",
              "right"
            )}
            ${createTimelineItem(
              "2024",
              "Sustainability Focus",
              "Launched our eco-friendly packaging initiative and partnered with sustainable brands to reduce our environmental impact.",
              "left"
            )}
            ${createTimelineItem(
              "2025",
              "The Future",
              "Continuing to innovate with AI-powered recommendations and expanding our community-driven features.",
              "right"
            )}
          </div>
        </div>
...
function createValueCard(
  ...
  return `
    <div class="bg-white dark:bg-gray-800/50 p-8 rounded-2xl hover:shadow-lg hover:shadow-${
      color === "#1649A1" ? "[#1649A1]" : "[#F35F25]"
    }/10 transition-all duration-500 group border border-gray-200 dark:border-gray-700/50">
